...
<div class="site-profile">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-5">
            <div class="panel panel-default">
                <div class="panel-heading"><?= 'Events type'?></div>
                <div class="panel-body">
                    <?php $form = ActiveForm::begin(['id' => 'form-events-type']); ?>
                    <?php foreach ($eventsTypeForm->events_type as $item) : ?>
                        <?= $form->field($eventsTypeForm, EventsTypeForm::PRE_NAME . current($item))
                            ->checkbox()->label($item['label']) ?>
                    <?php endforeach; ?>
                    <div class="form-group">
                        <?= Html::submitButton(Yii::t('users', 'SAVE'), ['class' => 'btn btn-primary', 'name' => 'events-type-button']) ?>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
